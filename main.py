...
analysis_data_input = input("Please enter your execution time from local machine: ")
analysis_data_docker_input = input("Please enter your execution time from docker container: ")
